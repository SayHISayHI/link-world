...
- Week 9/10 Alpha 聚合自动化门禁：`npm run readiness:alpha`，保存 JSON report；发布候选使用 `scripts/alpha-readiness.ps1 -IncludeSprintGates -IncludeTauriBuild -IncludeNetworkAudits` 并记录任何 audit waiver。
