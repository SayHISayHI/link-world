...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::evaluation::retry_evaluation,
            ...
            commands::organization::get_library_navigation,
            commands::organization::list_library_objects,
            commands::organization::create_collection,
            commands::organization::create_smart_view,
            commands::organization::update_collection,
            commands::organization::archive_collection,
            commands::organization::add_object_to_collection,
            commands::organization::remove_object_from_collection,
            commands::organization::mark_object_triaged,
            commands::organization::add_user_tag,
            commands::organization::remove_object_tag,
            commands::organization::accept_tag_suggestion,
            commands::organization::reject_tag_suggestion,
            commands::organization::get_object_organization,
